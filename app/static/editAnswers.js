...
function updateAnswer(id) {
  ...
  fields[0].innerHTML = `<input type='text' autocomplete='off' class='input-small' name='answer' data-role='input' value='${f[0].children[0].innerHTML.replace("'","&#39;")}'>
<small class='text-light'>Your Markdown tags are displayed as HTML. Leave as is or change back to Markdown. Unsafe tags will be removed or may lead to unwanted results.</small>`
  ...
  fields[2].innerHTML = `<input type='text' name='comment' autocomplete='off' class='input-small' data-role='input' value='${f[2].children[0].innerHTML.replace("'","&#39;")}'>`
